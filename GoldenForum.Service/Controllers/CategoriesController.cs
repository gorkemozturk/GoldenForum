...
namespace GoldenForum.Service.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        // GET: api/Categories
        [HttpGet]
        public async Task<ActionResult<IEnumerable<CategoryListViewModel>>> GetCategory()
        {
            return await _context.Categories.Include(c => c.Forums).Select(c => new CategoryListViewModel
            {
                Id = c.Id,
